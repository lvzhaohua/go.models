...
type DefaultClient interface {
	...
	SpuCount(ctx context.Context, in *SpuCountRequest, opts ...grpc.CallOption) (*SpuCountReply, error)
}
...
func (c *defaultClient) SpuCount(ctx context.Context, in *SpuCountRequest, opts ...grpc.CallOption) (*SpuCountReply, error) {
	out := new(SpuCountReply)
	err := c.cc.Invoke(ctx, "/product.Default/SpuCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
